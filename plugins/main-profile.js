...
await conn.sendMessage(m.chat, {text: loadd[i], edit: key })}*/
 ...
 • _*Umur:*_ ${user.registered ? age: ''}
 • _*Bio:*_ ${bio.status ? bio.status : bio}
 • _*Tag:*_ @${who.replace(/@.+/, '')}
 • _*Nomor:*_ ${PhoneNumber('+' + who.replace('@s.whatsapp.net', '')).getNumber('international')}
 • _*Link:*_ https://wa.me/${who.split`@`[0]}

 • _*Status:*_   ${who.split`@`[0] == global.nomorwa ? '🎗️Developer🎗️' : user.premiumTime >= 1 ? '👑ℙ𝕣𝕖𝕞𝕚𝕦𝕞👑' : user.level >= 1000 ? 'Elite User' : 'Free User'}
...
• _*Premium:*_ ${user.premiumTime > 0 ? "✅": "❌"} ${user.premiumTime > 0 ? `
• _*PremiumTime:*_
${clockString(user.premiumTime - new Date() * 1)}`: ''}

• _*Registered:*_ ${user.registered ? '✅ ( ' + new Date(regTime) + ' )' : '❌'}
`.trim()
